...
#ifndef DIGIKAM_GMIC_BQM_WIDGET_H
#define DIGIKAM_GMIC_BQM_WIDGET_H
...
class GmicBqmWidget : public QWidget
{
  Q_OBJECT

public:

  explicit GmicBqmWidget(QWidget * parent = nullptr);
  ~GmicBqmWidget() override;
...
#endif // DIGIKAM_GMIC_BQM_WIDGET_H
